...
g <- read.delim("~/chrisi/results/deseq/zuber+strobl-expressed-vs-notexpressed.deseq2.tsv")
...
write.table(gf, "~/chrisi/results/gsea/diff_exp_genes.rnk", col.names=F, row.names=F, sep="\t", quote=F)